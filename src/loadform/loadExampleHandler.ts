...
class LoadExampleHandler implements LoadHandler {
  ...
  constructor(exampleName: string) {
    switch (exampleName) {
      case "🇫🇷":
        this.localRelativePathToImage = "./examples/language_learning/krashen_spock.png";
        this.localRelativePathToAudio = "./examples/language_learning/fr/krashen_spock.wav";
        this.localRelativePathToActions = "./examples/language_learning/fr/krashen_spock.json";
        break;
      case "🇩🇪":
        this.localRelativePathToImage = "./examples/language_learning/krashen_spock.png";
        this.localRelativePathToAudio = "./examples/language_learning/de/krashen_spock.wav";
        this.localRelativePathToActions = "./examples/language_learning/de/krashen_spock.json";
        break;
      case "👨‍💻":
        this.localRelativePathToImage = "./examples/it_architecture/data_lake_on_gcp.png";
        this.localRelativePathToAudio = "./examples/it_architecture/data_lake_on_gcp.wav";
        this.localRelativePathToActions = "./examples/it_architecture/data_lake_on_gcp.json";
        break;
      default:
